                        ...
                        <li id="${item.id}" class="list-group-item text-wrap d-flex">
                            ...
                            ${item.is_checked
                                ...
                                : html`<div class="text text-wrap  pl-4" @dblclick="${TodoController.eventHandler.editItemEvent}" id="text" >        
                                    ${item.is_editable
                                        ?
                                        html` <input type="text" class="text form-control input background-light-grey" @keypress="${TodoController.eventHandler.enterKeyEvent}" @blur="${this.TodoController.eventHandler.blurEvent}"  aria-describedby="basic-addon2">`
                                        : 
                                        html`${item.text}`
                                    }
                                </div>`
